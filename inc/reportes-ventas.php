...
<div class="row">
    <div class="col-xs-6">
        <h3 class="text-center" hidden="hidden"><strong>Total:</strong> $<span id="mostrar_total"></span></h3>
    </div>
    <div class="col-xs-6">
        <h3 class="text-center" hidden="hidden"><strong>Ganancia:</strong> $<span id="mostrar_utilidad"></span></h3>
    </div>
</div>
