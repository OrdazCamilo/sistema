...
<div class="row">
    <div class="col-md-4 col-md-offset-4 col-xs-12">
        <button id="nuevo" class="btn btn-info form-control">Crear nuevo usuario <i class="fa fa-user-plus"></i></button>
    </div>
</div>
<br>
<div class="container">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center">Registrar usuario</h4>
            </div>
