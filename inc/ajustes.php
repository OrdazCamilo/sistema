...
<div class="container">
    <div class="col-xs-12">
        <h3 class="text-center">Impresora <i class="fa fa-print"></i></h3>
        <h5><strong>Seleccione la impresora:</strong></h5>
        <div class="form-group">
            <label for="impresoras">
                <strong>Nota: </strong>Elegir solamente impresoras físicas.
            </label>
...
<div class="container">
    <div class="col-xs-12">
        ...
        <p>Si no desea aportar alguno de los datos, dejar en blanco el campo.</p>
    </div>
    <div class="col-xs-12">
        <div class="form-group">
            <label for="nombre">Nombre de la empresa</label><input placeholder="Nombre" type="text" id="nombre" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="rfc">RIF</label><input placeholder="RFC" type="text" id="rfc" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="colonia">Estado</label><input placeholder="Colonia" type="text" id="colonia"
                                                       class="form-control">
        </div>
        <div class="form-group">
