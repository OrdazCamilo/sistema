        ...
        <div class="col-xs-12 col-md-4" id="contenedor_formulario">
            ...
            <div class="form-group">
                ...
                <input data-requerido="true" class="form-control" type="text" id="id_producto"
                       placeholder="ID o código del producto">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <p hidden="hidden" class="h5"><strong>Ganancia: </strong>$<span id="mostrar_utilidad"></span></p>
            </div>
            <div class="form-group">
                <label for="inventario">Existencia</label>
                <input data-requerido="true" class="form-control" type="number" id="inventario"
                       placeholder="Cantidad de productos en stock">
            </div>
            <div class="form-group">
                <label for="stock">Existencia mínima</label>
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-md-offset-3 col-xs-12">
                    <button id="guardar_producto" class="form-control btn btn-success">Guardar</button>
                </div>
                <div class="col-xs-6 col-md-offset-3 col-xs-12" hidden="hidden">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="btn-group btn-group-justified">
                        <div class="btn-group">
                            <button id="cargar_productos_nuevos" type="button" class="btn btn-link"><i
                                    class="fa fa-arrow-left"></i> Productos nuevos
                            </button>
                        </div>
                        <div class="btn-group">
                            <button id="cargar_productos_antiguos" type="button" class="btn btn-link">Productos
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="h5">¿Deseas eliminar el producto? No se puede deshacer.</p>
            </div>
...
<div id="modal_agregar_piezas" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title text-center">Agregar piezas</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <textarea style="resize: none;" class="form-control" placeholder="Detalle la razón de baja del producto seleccionado" type="number"
            ...
            <div class="modal-footer">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <button id="dar_baja" class="form-control btn btn-danger">Dar de baja</button>
                    </div>
                </div>
            </div>
        </div>
