    ...
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li id="elem_ventas"><a href="./ventas"><i class="fa fa-usd"></i> Iniciar venta</a></li>
                <li id="elem_inventarios"><a href="./inventarios"><i class="fa fa-book"></i> Inventario</a></li>
                <li id="elem_caja"><a href="./caja"><i class="fa fa-money"></i> Ingresar en caja</a></li>
                <li id="elem_gastos"><a href="./gastos"><i class="fa fa-calculator"></i> Salidas</a></li>
                <li id="elem_reportes" class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="./reportes-inventarios">Inventario</a></li>
                        ...
                        <li><a href="./reportes-gastos">Salidas</a></li>
